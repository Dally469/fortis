                ...
                <v-col cols="12" sm="8">
                    <div class="text-center">
                        ...
                        <h2 class="text-h2 text-dark mb-3" data-aos="fade-left" data-aos-delay="200"
                            ...
                            <p class="text-muted mb-4">We are one of the fastest growing law and top-tier firms in Rwanda, with significant depth and expertise across a broad range of practice areas.</p>
                    </div>
                </v-col>
            </v-row>
            <v-row class="justify-center">
