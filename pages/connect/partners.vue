...
<template>
  ...
  <PageHeroBanner
    ...
    subtitle="Become more than a partner; become a catalyst for change. Together, we can mold a future where access to justice is not a privilege, but a universal right."
  />
